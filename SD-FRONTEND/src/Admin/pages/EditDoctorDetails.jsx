      ...
      <div className="flex items-center justify-between mb-6">
        ...
        >
          <img
            ...
            className="w-6 h-6"
          />
          <span className="text-green-600 font-medium">Back to List</span>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-green-400 focus:outline-none mb-2"
              required
            />
            <input
              value={address2}
