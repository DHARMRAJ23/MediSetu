    ...
    <div className="container mx-auto px-6 py-12 space-y-16">
      ...
      >
        <h1 className="text-4xl md:text-5xl font-bold text-gray-800">
          About <span className="text-green-500">MediSetu</span>
        </h1>
        <p className="text-gray-600 leading-relaxed">
          Welcome to <span className="font-semibold text-green-600">MediSetu</span>, your trusted partner in managing healthcare 
      ...
      <div className="text-center space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <motion.div
            whileHover={{ y: -10 }}
            className="bg-gradient-to-br from-green-50 to-white rounded-2xl shadow-lg p-8 text-center space-y-4 hover:shadow-2xl transition-all duration-300"
          >
