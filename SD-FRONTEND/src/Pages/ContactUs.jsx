      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        ...
        <div className="space-y-6 bg-white shadow-lg rounded-2xl p-6">
          ...
          <p>
            ...
            >
              info@medisetuhospital.com
            </a>
          </p>
          <p>
            Appointments:{" "}
            <a
              href="medisetu-hospital.netlify.app"
              className="text-green-500 hover:underline"
            >
              medisetu-hospital.netlify.app
            </a>
          </p>
          <p>
            Billing:{" "}
            <a
              ...
              className="text-green-500 hover:underline"
            >
              billing@medisetuhospital.com
            </a>
          </p>

          <h1 className="text-2xl font-semibold text-green-700">Visiting Hours</h1>
          ...
          <form className="flex flex-col space-y-4" onSubmit={onSubmit}>
            <div className="flex flex-col">
              ...
              <input
                ...
                required
                className="p-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-400 outline-none"
              />
            </div>
            <div className="flex flex-col">
