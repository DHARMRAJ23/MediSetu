    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <input
            ...
            className="w-full border border-gray-300 px-4 py-2 rounded-xl focus:ring-2 focus:ring-green-400 focus:outline-none"
          />
        </div>
        <div>
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full border border-gray-300 px-4 py-3 rounded-xl focus:ring-2 focus:ring-green-400 focus:outline-none"
          rows={3}
        />
      </div>
