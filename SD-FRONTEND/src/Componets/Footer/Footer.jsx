  ...
  return (
    <footer className="bg-zinc-100 text-zinc-700 mt-10 z-10 px-10">
      {/* {!getrole && (  <div className="container mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-3 gap-10">
        <div>
          <img 
            src="https://medisetu.vercel.app/assets/logo-BNCDj_dh.svg" 
            alt="Logo" 
            className="w-32 mb-4"
          />
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li className="hover:text-green-600 cursor-pointer" onClick={()=>navigate('/')}>Home</li>
            <li className="hover:text-green-600 cursor-pointer"onClick={()=>navigate('/about')}>About</li>
            <li className="hover:text-green-600 cursor-pointer">Delivery</li>
      ...
      <div className="border-t border-zinc-300 py-4 text-center text-sm text-zinc-500">
        © 2026 MediSetu - All Rights Reserved.
      </div>
    </footer>
  )
}
