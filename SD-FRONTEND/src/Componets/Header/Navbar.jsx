...
const Navbar = () => {
          ...
          {getrole === "Admin" ? (
            <div className="flex items-center justify-between px-6 py-3 bg-transparent rounded-lg relative">
              <div className=" flex  justify-between items-center gap-2">
                ...
                >
                  <p className="text-4xl font-extrabold bg-green-800 bg-clip-text text-transparent drop-shadow-lg">
                    MediSetu
                  </p>
                </Link>
              ...
              <div className="flex items-center gap-4 cursor-pointer">
                ...
                <button
                  className="bg-green-500 px-5 py-1 rounded-2xl text-white hover:bg-red-500  cursor-pointer"
              ...
              <div className=" relative hidden md:flex items-center gap-6 px-10">
                ...
                {getrole === "user" ? (
                  ...
                  <div className="cursor-pointer  whitespace-nowrap">
                    <button
                      className="bg-green-400 text-black py-1 px-6 text-sm rounded-2xl  hover:bg-green-500"
  ...
  <div className="md:hidden flex flex-col items-center gap-4 py-6 bg-white border-t shadow-lg animate-slide-down relative">
    ...
    {getrole === "user" ? (
      ...
      <>
        <button
          className="bg-green-500 text-white font-semibold py-2 px-6 rounded-xl hover:bg-green-600 transition"
          onClick={() => {
            setMenuOpen(false);
            navigate("/login");
          }}
